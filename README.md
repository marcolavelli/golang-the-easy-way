...
###### Tabella 2 - Strutture di dati in Go e istruzione letterale
| struttura | istruzione letterale | 
| :---------- | :---------- | 
| struct | {red: 128, green: 0, blue: 128} |
| array | [3]int{128, 0, 128}|
| slice | []int{128, 0, 128} |
| map | map[string]int{"red": 128, "green": 0, "blue": 128} |
