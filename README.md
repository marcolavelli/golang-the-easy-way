...
###### Tabella 2 - Strutture di dati in Go suddivisi e dichiarazione letterale
| struttura | dichiarazione  | 
| :---------- | :---------- | 
| struct | *purpleStruct := {red: 128, green: 0, blue: 128}* |
| array | *purpleArray := [3]int{128, 0, 128}*|
| slice | *purpleSlice := []int{128, 0, 128} |
| map | *purpleMap := map[string]int{"red": 128, "green": 0, "blue": 128} |
